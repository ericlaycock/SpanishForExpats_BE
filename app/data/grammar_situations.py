...
GRAMMAR_SITUATIONS = {
    ...
    "grammar_regular_present_ar_2": {
        # `escuchar` was repeated from drill 1; swapped to `caminar` so each -ar
        # verb appears only once across the family's drills (ID kept unchanged).
        "title": "Regular Present — -AR (2/2)",
        "grammar_level": 3,
        "lesson_number": 2,
        "lesson_type": "conjugation",
        "word_workload": ["cantar", "caminar"],
        "video_embed_id": "6jpCj97AHMN",
        "drill_type": "conjugation",
        "tense": "present",
        "intro_chart": {'kind': 'cards', 'title': 'Regular present — -AR verbs', 'cards': [{'kind': 'text', 'title': 'Verbs change to match who', 'body': 'In Spanish, the verb itself tells you who is doing the action. The infinitive form (the dictionary form, like *hablar* — to speak) drops its ending and gets a new one based on the subject.'}, {'kind': 'text', 'title': 'Three families: -ar, -er, -ir — starting with -ar', 'body': "Every Spanish infinitive ends in **-ar**, **-er**, or **-ir**. Each family takes its own endings. We'll start with the most common: **-ar** verbs (hablar, escuchar, cantar, caminar…)."}, {'kind': 'mini_table', 'title': 'cantar (to sing)', 'rows': [['yo', 'cant|o'], ['tú', 'cant|as'], ['él / ella / usted', 'cant|a'], ['nosotros / nosotras', 'cant|amos'], ['ellos / ellas / ustedes', 'cant|an']]}, {'kind': 'mini_table', 'title': 'caminar (to walk)', 'rows': [['yo', 'camin|o'], ['tú', 'camin|as'], ['él / ella / usted', 'camin|a'], ['nosotros / nosotras', 'camin|amos'], ['ellos / ellas / ustedes', 'camin|an']]}], 'recall': [{'verb': 'cantar', 'answers': {'yo': 'cant|o', 'tú': 'cant|as', 'él': 'cant|a', 'nosotros': 'cant|amos', 'ellos': 'cant|an'}}, {'verb': 'caminar', 'answers': {'yo': 'camin|o', 'tú': 'camin|as', 'él': 'camin|a', 'nosotros': 'camin|amos', 'ellos': 'camin|an'}}]},
        "drill_config": {
            "answers": {
                "cantar": {
                ...
                "caminar": {
                    "yo": "camin|o", "tú": "camin|as", "él": "camin|a", "ella": "camin|a",
                    "usted": "camin|a", "nosotros": "camin|amos", "nosotras": "camin|amos",
                    "ellos": "camin|an", "ellas": "camin|an", "ustedes": "camin|an",
                },
            },
        },
        "phases": {"0a": True, "0b": True, "1a": False, "1b": False, "1c": False, "2": False, "3": False},
        ...
        "drill_sentences": [
            ...
            {"en": "They (m) sing a song", "es": "Ellos cantan una canción", "noun_id": None, "type": "written",
             "glosses": {"song": "canción", "canción": "song"}},
            {"en": "I walk to school", "es": "Yo camino a la escuela", "noun_id": None, "type": "auditory",
             "glosses": {"school": "escuela", "escuela": "school"}},
            {"en": "You walk in the park", "es": "Tú caminas en el parque", "noun_id": None, "type": "written",
             "glosses": {"park": "parque", "parque": "park"}},
            {"en": "He walks slowly", "es": "Él camina despacio", "noun_id": None, "type": "auditory",
             "glosses": {"slowly": "despacio", "despacio": "slowly"}},
            {"en": "We (m) walk every morning", "es": "Nosotros caminamos cada mañana", "noun_id": None, "type": "written",
             "glosses": {"every": "cada", "morning": "mañana", "cada": "every", "mañana": "morning"}},
            {"en": "You all walk fast", "es": "Ustedes caminan rápido", "noun_id": None, "type": "auditory",
             "glosses": {"fast": "rápido", "rápido": "fast"}},
        ],
        "drill_targets": [
            {"verb": "cantar", "pronoun": "yo"}, {"verb": "cantar", "pronoun": "tú"},
            {"verb": "cantar", "pronoun": "ella"}, {"verb": "cantar", "pronoun": "nosotras"},
            {"verb": "cantar", "pronoun": "ellos"}, {"verb": "caminar", "pronoun": "yo"},
            {"verb": "caminar", "pronoun": "tú"}, {"verb": "caminar", "pronoun": "usted"},
            {"verb": "caminar", "pronoun": "nosotros"}, {"verb": "caminar", "pronoun": "ellas"},
        ],
        "phase_2_config": {
            "description": "Regular Present -AR (2/2): cantar, caminar",
            "targets": [
                {"verb": "cantar", "pronoun": "yo"}, {"verb": "cantar", "pronoun": "tú"},
                {"verb": "cantar", "pronoun": "ella"}, {"verb": "cantar", "pronoun": "nosotras"},
                {"verb": "cantar", "pronoun": "ellos"}, {"verb": "caminar", "pronoun": "yo"},
    ...
    "grammar_regular_present_er_2": {
        # `comer` was repeated from drill 1; swapped to `creer` so each -er verb
        # appears only once across the family's drills (ID kept unchanged).
        "title": "Regular Present — -ER (2/2)",
        "grammar_level": 3,
        "lesson_number": 4,
        "lesson_type": "conjugation",
        "word_workload": ["leer", "creer"],
        "video_embed_id": "6jpCj97AHMN",
        "drill_type": "conjugation",
        "tense": "present",
        "intro_chart": {'kind': 'cards', 'title': 'Regular present — -ER verbs', 'cards': [{'kind': 'text', 'title': 'Now: -er verbs', 'body': 'You already know the -ar pattern. -er verbs (beber, comer, leer, creer…) work the same way — drop the ending, add a new one — but the endings are different.'}, {'kind': 'mini_table', 'title': 'leer (to read)', 'rows': [['yo', 'le|o'], ['tú', 'le|es'], ['él / ella / usted', 'le|e'], ['nosotros / nosotras', 'le|emos'], ['ellos / ellas / ustedes', 'le|en']]}, {'kind': 'mini_table', 'title': 'creer (to believe)', 'rows': [['yo', 'cre|o'], ['tú', 'cre|es'], ['él / ella / usted', 'cre|e'], ['nosotros / nosotras', 'cre|emos'], ['ellos / ellas / ustedes', 'cre|en']]}], 'recall': [{'verb': 'leer', 'answers': {'yo': 'le|o', 'tú': 'le|es', 'él': 'le|e', 'nosotros': 'le|emos', 'ellos': 'le|en'}}, {'verb': 'creer', 'answers': {'yo': 'cre|o', 'tú': 'cre|es', 'él': 'cre|e', 'nosotros': 'cre|emos', 'ellos': 'cre|en'}}]},
        "drill_config": {
            "answers": {
                "leer": {
                ...
                "creer": {
                    "yo": "cre|o", "tú": "cre|es", "él": "cre|e", "ella": "cre|e",
                    "usted": "cre|e", "nosotros": "cre|emos", "nosotras": "cre|emos",
                    "ellos": "cre|en", "ellas": "cre|en", "ustedes": "cre|en",
                },
            },
        },
        "phases": {"0a": True, "0b": True, "1a": False, "1b": False, "1c": False, "2": False, "3": False},
        ...
        "drill_sentences": [
            ...
            {"en": "They (m) read fast", "es": "Ellos leen rápido", "noun_id": None, "type": "written",
             "glosses": {"fast": "rápido", "rápido": "fast"}},
            {"en": "I believe the story", "es": "Yo creo la historia", "noun_id": None, "type": "auditory",
             "glosses": {"story": "historia", "historia": "story"}},
            {"en": "You believe me", "es": "Tú me crees", "noun_id": None, "type": "written",
             "glosses": {}},
            {"en": "She believes the news", "es": "Ella cree las noticias", "noun_id": None, "type": "auditory",
             "glosses": {"news": "noticias", "noticias": "news"}},
            {"en": "We (m) believe the truth", "es": "Nosotros creemos la verdad", "noun_id": None, "type": "written",
             "glosses": {"truth": "verdad", "verdad": "truth"}},
            {"en": "You all believe the teacher", "es": "Ustedes creen al profesor", "noun_id": None, "type": "auditory",
             "glosses": {"teacher": "profesor", "profesor": "teacher"}},
        ],
        "drill_targets": [
            {"verb": "leer", "pronoun": "yo"}, {"verb": "leer", "pronoun": "tú"},
            {"verb": "leer", "pronoun": "ella"}, {"verb": "leer", "pronoun": "nosotras"},
            {"verb": "leer", "pronoun": "ellos"}, {"verb": "creer", "pronoun": "tú"},
            {"verb": "creer", "pronoun": "él"}, {"verb": "creer", "pronoun": "usted"},
            {"verb": "creer", "pronoun": "nosotros"}, {"verb": "creer", "pronoun": "ellas"},
        ],
        "phase_2_config": {
            "description": "Regular Present -ER (2/2): leer, creer",
            "targets": [
                {"verb": "leer", "pronoun": "yo"}, {"verb": "leer", "pronoun": "tú"},
                {"verb": "leer", "pronoun": "ella"}, {"verb": "leer", "pronoun": "nosotras"},
                {"verb": "leer", "pronoun": "ellos"}, {"verb": "creer", "pronoun": "tú"},
    ...
    "grammar_regular_present_ir_2": {
        # `vivir` was repeated from drill 1; swapped to `recibir` so each -ir verb
        # appears only once across the family's drills (ID kept unchanged).
        "title": "Regular Present — -IR (2/2)",
        "grammar_level": 3,
        "lesson_number": 6,
        "lesson_type": "conjugation",
        "word_workload": ["abrir", "recibir"],
        "video_embed_id": "6jpCj97AHMN",
        "drill_type": "conjugation",
        "tense": "present",
        "intro_chart": {'kind': 'cards', 'title': 'Regular present — -IR verbs', 'cards': [{'kind': 'text', 'title': 'Last family: -ir verbs', 'body': '-ir verbs (vivir, escribir, abrir, recibir…) share almost every ending with -er. The only difference is the *nosotros* form: -er says **-emos**, -ir says **-imos**.'}, {'kind': 'mini_table', 'title': 'abrir (to open)', 'rows': [['yo', 'abr|o'], ['tú', 'abr|es'], ['él / ella / usted', 'abr|e'], ['nosotros / nosotras', 'abr|imos'], ['ellos / ellas / ustedes', 'abr|en']]}, {'kind': 'mini_table', 'title': 'recibir (to receive)', 'rows': [['yo', 'recib|o'], ['tú', 'recib|es'], ['él / ella / usted', 'recib|e'], ['nosotros / nosotras', 'recib|imos'], ['ellos / ellas / ustedes', 'recib|en']]}], 'recall': [{'verb': 'abrir', 'answers': {'yo': 'abr|o', 'tú': 'abr|es', 'él': 'abr|e', 'nosotros': 'abr|imos', 'ellos': 'abr|en'}}, {'verb': 'recibir', 'answers': {'yo': 'recib|o', 'tú': 'recib|es', 'él': 'recib|e', 'nosotros': 'recib|imos', 'ellos': 'recib|en'}}]},
        "drill_config": {
            "answers": {
                "abrir": {
                ...
                "recibir": {
                    "yo": "recib|o", "tú": "recib|es", "él": "recib|e", "ella": "recib|e",
                    "usted": "recib|e", "nosotros": "recib|imos", "nosotras": "recib|imos",
                    "ellos": "recib|en", "ellas": "recib|en", "ustedes": "recib|en",
                },
            },
        },
        "phases": {"0a": True, "0b": True, "1a": False, "1b": False, "1c": False, "2": False, "3": False},
        ...
        "drill_sentences": [
            ...
            {"en": "I receive a letter", "es": "Yo recibo una carta", "noun_id": None, "type": "auditory",
             "glosses": {"letter": "carta", "carta": "letter"}},
            {"en": "You receive good news", "es": "Tú recibes buenas noticias", "noun_id": None, "type": "written",
             "glosses": {"news": "noticias", "noticias": "news"}},
            {"en": "She receives the package", "es": "Ella recibe el paquete", "noun_id": None, "type": "auditory",
             "glosses": {"package": "paquete", "paquete": "package"}},
            {"en": "We (m) receive visitors", "es": "Nosotros recibimos visitas", "noun_id": None, "type": "written",
             "glosses": {"visitors": "visitas", "visitas": "visitors"}},
            {"en": "You all receive an answer", "es": "Ustedes reciben una respuesta", "noun_id": None, "type": "auditory",
             "glosses": {"answer": "respuesta", "respuesta": "answer"}},
        ],
        "drill_targets": [
            {"verb": "abrir", "pronoun": "yo"}, {"verb": "abrir", "pronoun": "tú"},
            {"verb": "abrir", "pronoun": "ella"}, {"verb": "abrir", "pronoun": "nosotras"},
            {"verb": "abrir", "pronoun": "ellos"}, {"verb": "recibir", "pronoun": "tú"},
            {"verb": "recibir", "pronoun": "él"}, {"verb": "recibir", "pronoun": "usted"},
            {"verb": "recibir", "pronoun": "nosotras"}, {"verb": "recibir", "pronoun": "ellas"},
        ],
        "phase_2_config": {
            "description": "Regular Present -IR (2/2): abrir, recibir",
            "targets": [
                {"verb": "abrir", "pronoun": "yo"}, {"verb": "abrir", "pronoun": "tú"},
                {"verb": "abrir", "pronoun": "ella"}, {"verb": "abrir", "pronoun": "nosotras"},
                {"verb": "abrir", "pronoun": "ellos"}, {"verb": "recibir", "pronoun": "tú"},
    ...
    'grammar_imperfect_4': {
        ...
        'drill_type': 'conjugation',
        'tense': 'imperfect',
        "intro_chart": {'kind': 'cards', 'title': 'Imperfect — the only two irregulars so far', 'cards': [{'kind': 'text', 'title': 'The imperfect is almost always regular', 'body': "Good news: the imperfect is the most regular tense in Spanish. Almost every verb follows the same *-aba* (for -ar) or *-ía* (for -er/-ir) pattern you've already drilled. **Only three Spanish verbs are truly irregular in the imperfect: *ser*, *ir*, and *ver*.** This lesson teaches the first two — *ver* comes in the next lesson, and that's the entire irregular list."}, {'kind': 'mini_table', 'title': 'ir (to go)', 'rows': [['yo', 'iba'], ['tú', 'ibas'], ['él / ella / usted', 'iba'], ['nosotros / nosotras', 'íbamos'], ['ellos / ellas / ustedes', 'iban']]}, {'kind': 'mini_table', 'title': 'ser (to be)', 'rows': [['yo', 'era'], ['tú', 'eras'], ['él / ella / usted', 'era'], ['nosotros / nosotras', 'éramos'], ['ellos / ellas / ustedes', 'eran']]}], 'recall': [{'verb': 'ir', 'answers': {'yo': 'iba', 'tú': 'ibas', 'él': 'iba', 'nosotros': 'íbamos', 'ellos': 'iban'}}, {'verb': 'ser', 'answers': {'yo': 'era', 'tú': 'eras', 'él': 'era', 'nosotros': 'éramos', 'ellos': 'eran'}}]},
        'drill_config': {
            'answers': {
                'ir': {
                    'yo': 'iba',
    ...
    'grammar_imperfect_5': {
        ...
        'drill_type': 'conjugation',
        'tense': 'imperfect',
        "intro_chart": {'kind': 'cards', 'title': 'Imperfect — the last irregular + a regular -ir', 'cards': [{'kind': 'text', 'title': '*Ver* is the third (and last) irregular imperfect', 'body': "After *ser* and *ir*, **ver** is the third and final irregular imperfect verb in Spanish. Once you've drilled these three, every other Spanish verb you'll ever conjugate in the imperfect follows the regular *-aba* / *-ía* pattern. This lesson pairs *ver* (irregular) with *escribir* (a textbook regular -ir verb) so you can feel the contrast side by side."}, {'kind': 'mini_table', 'title': 'ver (to see) — irregular', 'rows': [['yo', 'veía'], ['tú', 'veías'], ['él / ella / usted', 'veía'], ['nosotros / nosotras', 'veíamos'], ['ellos / ellas / ustedes', 'veían']]}, {'kind': 'mini_table', 'title': 'escribir (to write) — regular -ir', 'rows': [['yo', 'escribía'], ['tú', 'escribías'], ['él / ella / usted', 'escribía'], ['nosotros / nosotras', 'escribíamos'], ['ellos / ellas / ustedes', 'escribían']]}], 'recall': [{'verb': 'ver', 'answers': {'yo': 'veía', 'tú': 'veías', 'él': 'veía', 'nosotros': 'veíamos', 'ellos': 'veían'}}, {'verb': 'escribir', 'answers': {'yo': 'escribía', 'tú': 'escribías', 'él': 'escribía', 'nosotros': 'escribíamos', 'ellos': 'escribían'}}]},
        'drill_config': {
            'answers': {
                'ver': {
                    'yo': 'veía',
...
"grammar_ir_a_inf_hablar_comer_1": {
    ...
    "grammar_ir_a_inf_hablar_comer_2": {
        # ID kept for stability (never-rename rule); content is now cantar + leer
        # so the ir-a-inf drills don't repeat hablar/comer from drill 1.
        "title": "ir a + Infinitive — cantar + leer (2/2)",
        "grammar_level": 9,
        "lesson_number": 2,
        "lesson_type": "conjugation",
        "word_workload": ["cantar", "leer"],
        "video_embed_id": "geHPDI9tMdH",
        "drill_type": "ir_a_inf",
        "tense": "ir_a_infinitive",
        "intro_chart": {'kind': 'cards', 'title': 'ir a + Infinitive — cantar + leer', 'cards': [{'kind': 'text', 'title': 'cantar + leer', 'body': "**ir + a + infinitive** is the everyday Spanish 'going-to' future. Conjugate **ir** (voy, vas, va, vamos, van), add **a**, then any infinitive. *Voy a cantar* = I'm going to sing."}, {'kind': 'text', 'title': 'What changes, what stays', 'body': "This sub-block uses **cantar** (to sing) and **leer** (to read) as the infinitives. The conjugated part — ir — is what you're learning to flex."}, {'kind': 'mini_table', 'title': 'cantar (to sing)', 'rows': [['yo', '|voy a cantar'], ['tú', '|vas a cantar'], ['él / ella / usted', '|va a cantar'], ['nosotros / nosotras', '|vamos a cantar'], ['ellos / ellas / ustedes', '|van a cantar']]}, {'kind': 'mini_table', 'title': 'leer (to read)', 'rows': [['yo', '|voy a leer'], ['tú', '|vas a leer'], ['él / ella / usted', '|va a leer'], ['nosotros / nosotras', '|vamos a leer'], ['ellos / ellas / ustedes', '|van a leer']]}], 'recall': [{'verb': 'cantar', 'answers': {'yo': '|voy a cantar', 'tú': '|vas a cantar', 'él': '|va a cantar', 'nosotros': '|vamos a cantar', 'ellos': '|van a cantar'}}, {'verb': 'leer', 'answers': {'yo': '|voy a leer', 'tú': '|vas a leer', 'él': '|va a leer', 'nosotros': '|vamos a leer', 'ellos': '|van a leer'}}]},
        "drill_config": {
            "answers": {
                "cantar": {"yo": "|voy a cantar", "tú": "|vas a cantar", "él": "|va a cantar", "ella": "|va a cantar", "usted": "|va a cantar", "nosotros": "|vamos a cantar", "nosotras": "|vamos a cantar", "ellos": "|van a cantar", "ellas": "|van a cantar", "ustedes": "|van a cantar"},
                "leer": {"yo": "|voy a leer", "tú": "|vas a leer", "él": "|va a leer", "ella": "|va a leer", "usted": "|va a leer", "nosotros": "|vamos a leer", "nosotras": "|vamos a leer", "ellos": "|van a leer", "ellas": "|van a leer", "ustedes": "|van a leer"},
            },
        },
        "phases": {"0a": True, "0b": True, "1a": False, "1b": False, "1c": False, "2": False, "3": False},
        "phase_1c_config": {"total_items": 5, "mode": "random_pronoun_verb"},
        "drill_sentences": [
            {"en": "You are going to sing at the party.", "es": "Tú vas a cantar en la fiesta.", "noun_id": None, "type": "written", "glosses": {"party": "fiesta", "fiesta": "party"}},
            {"en": "I am going to sing a song now.", "es": "Yo voy a cantar una canción ahora.", "noun_id": None, "type": "auditory", "glosses": {"song": "canción", "now": "ahora", "canción": "song", "ahora": "now"}},
            {"en": "She is going to sing in the choir.", "es": "Ella va a cantar en el coro.", "noun_id": None, "type": "written", "glosses": {"choir": "coro", "coro": "choir"}},
            {"en": "We (f) are going to sing together.", "es": "Nosotras vamos a cantar juntas.", "noun_id": None, "type": "auditory", "glosses": {"together": "juntas", "juntas": "together"}},
            {"en": "You all are going to sing very loudly.", "es": "Ustedes van a cantar muy alto.", "noun_id": None, "type": "written", "glosses": {"loudly": "alto", "alto": "loudly"}},
            {"en": "You are going to read the book.", "es": "Tú vas a leer el libro.", "noun_id": None, "type": "written", "glosses": {"book": "libro", "libro": "book"}},
            {"en": "I am going to read the news today.", "es": "Yo voy a leer las noticias hoy.", "noun_id": None, "type": "auditory", "glosses": {"news": "noticias", "today": "hoy", "noticias": "news", "hoy": "today"}},
            {"en": "She is going to read a long story.", "es": "Ella va a leer un cuento largo.", "noun_id": None, "type": "written", "glosses": {"story": "cuento", "long": "largo", "cuento": "story", "largo": "long"}},
            {"en": "We (f) are going to read in the library.", "es": "Nosotras vamos a leer en la biblioteca.", "noun_id": None, "type": "auditory", "glosses": {"library": "biblioteca", "biblioteca": "library"}},
            {"en": "You all are going to read magazines.", "es": "Ustedes van a leer revistas.", "noun_id": None, "type": "written", "glosses": {"magazines": "revistas", "revistas": "magazines"}},
        ],
        "drill_targets": [{"verb": "cantar", "pronoun": "yo"}, {"verb": "cantar", "pronoun": "tú"}, {"verb": "cantar", "pronoun": "ella"}, {"verb": "cantar", "pronoun": "nosotras"}, {"verb": "cantar", "pronoun": "ustedes"}, {"verb": "leer", "pronoun": "tú"}, {"verb": "leer", "pronoun": "él"}, {"verb": "leer", "pronoun": "usted"}, {"verb": "leer", "pronoun": "nosotros"}, {"verb": "leer", "pronoun": "ellas"}],
        "phase_2_config": {
            "description": "ir a + Infinitive cantar + leer (2/2): cantar, leer",
            "targets": [{"verb": "cantar", "pronoun": "yo"}, {"verb": "cantar", "pronoun": "tú"}, {"verb": "cantar", "pronoun": "ella"}, {"verb": "cantar", "pronoun": "nosotras"}, {"verb": "cantar", "pronoun": "ustedes"}, {"verb": "leer", "pronoun": "tú"}, {"verb": "leer", "pronoun": "él"}, {"verb": "leer", "pronoun": "usted"}, {"verb": "leer", "pronoun": "nosotros"}, {"verb": "leer", "pronoun": "ellas"}],
        },
        "opener_en": "What are you going to read?",
        "opener_es": "¿Qué vas a leer?",
    },
