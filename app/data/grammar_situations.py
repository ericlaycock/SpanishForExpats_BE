...
GRAMMAR_SITUATIONS = {
    ...
    "grammar_irregular_present_ii_1": {
        ...
        "drill_sentences": [
            ...
            {"en": "We (m) put the table", "es": "Nosotros ponemos la mesa", "noun_id": None, "type": "auditory", "glosses": {"table": "mesa", "mesa": "table"}},
            {"en": "We (f) leave from home", "es": "Nosotras salimos de casa", "noun_id": "casa", "type": "written", "glosses": {"at home": "en casa", "en casa": "at home"}},
            {"en": "They (m) say hi", "es": "Ellos dicen hola", "noun_id": None, "type": "auditory", "glosses": {"hi": "hola", "hola": "hi"}},
    ...
    "grammar_irregular_present_ii_2": {
        ...
        "drill_sentences": [
            ...
            {"en": "We (m) fall asleep", "es": "Nosotros caemos dormido", "noun_id": None, "type": "auditory", "glosses": {}},
            {"en": "We (f) bring the book", "es": "Nosotras traemos el libro", "noun_id": "libro", "type": "written", "glosses": {"book": "libro", "libro": "book"}},
            {"en": "They (m) be worth little", "es": "Ellos valen poco", "noun_id": None, "type": "auditory", "glosses": {"little": "poco", "poco": "little"}},
    ...
    "grammar_irregular_present_ii_3": {
        ...
        "drill_sentences": [
            ...
            {"en": "We (m) put music", "es": "Nosotros ponemos música", "noun_id": None, "type": "auditory", "glosses": {}},
            {"en": "We (f) leave together", "es": "Nosotras salimos juntos", "noun_id": None, "type": "written", "glosses": {}},
            {"en": "They (m) say nothing", "es": "Ellos dicen nada", "noun_id": None, "type": "auditory", "glosses": {}},
    ...
    "grammar_irregular_present_ii_4": {
        ...
        "drill_sentences": [
            ...
            {"en": "We (m) fall fast", "es": "Nosotros caemos rápido", "noun_id": None, "type": "auditory", "glosses": {"fast": "rápido", "rápido": "fast"}},
            {"en": "We (f) bring coffee", "es": "Nosotras traemos café", "noun_id": "café", "type": "written", "glosses": {}},
            {"en": "They (m) be worth the wait", "es": "Ellos valen la espera", "noun_id": None, "type": "auditory", "glosses": {"wait": "espera", "espera": "wait"}},
    ...
    "grammar_spelling_changes_1": {
        ...
        "drill_sentences": [
            ...
            {"en": "We (m) produce coffee", "es": "Nosotros producimos café", "noun_id": "café", "type": "auditory", "glosses": {"coffee": "café", "café": "coffee"}},
            {"en": "We (f) build a bridge", "es": "Nosotras construimos un puente", "noun_id": None, "type": "written", "glosses": {"bridge": "puente", "puente": "bridge"}},
            {"en": "They (m) get money", "es": "Ellos consiguen dinero", "noun_id": "dinero", "type": "auditory", "glosses": {"money": "dinero", "dinero": "money"}},
    ...
    "grammar_spelling_changes_2": {
        ...
        "drill_sentences": [
            ...
            {"en": "We (m) direct the project", "es": "Nosotros dirigimos el proyecto", "noun_id": None, "type": "auditory", "glosses": {"project": "proyecto", "proyecto": "project"}},
            ...
            {"en": "They (m) continue here", "es": "Ellos continúan aquí", "noun_id": None, "type": "auditory", "glosses": {}},
    ...
    "grammar_spelling_changes_3": {
        ...
        "drill_sentences": [
            ...
            {"en": "We (m) produce good wine", "es": "Nosotros producimos buen vino", "noun_id": None, "type": "auditory", "glosses": {}},
            {"en": "We (f) build fast", "es": "Nosotras construimos rápido", "noun_id": None, "type": "written", "glosses": {"fast": "rápido", "rápido": "fast"}},
            {"en": "They (m) get a ticket", "es": "Ellos consiguen una entrada", "noun_id": None, "type": "auditory", "glosses": {}},
    ...
    "grammar_spelling_changes_4": {
        ...
        "drill_sentences": [
            ...
            {"en": "We (m) direct an orchestra", "es": "Nosotros dirigimos una orquesta", "noun_id": None, "type": "auditory", "glosses": {"orchestra": "orquesta", "orquesta": "orchestra"}},
            {"en": "We (f) convince everyone", "es": "Nosotras convencemos a todos", "noun_id": None, "type": "written", "glosses": {}},
            {"en": "They (m) continue together", "es": "Ellos continúan juntos", "noun_id": None, "type": "auditory", "glosses": {"together": "juntos", "juntos": "together"}},
    ...
    "grammar_present_o_ue_1": {
        ...
        "drill_sentences": [
            ...
            {"en": "We (m) return home", "es": "Nosotros volvemos a casa", "noun_id": "casa", "type": "auditory", "glosses": {"at home": "en casa", "en casa": "at home"}},
            {"en": "We (f) move the chair", "es": "Nosotras movemos la silla", "noun_id": None, "type": "written", "glosses": {"chair": "silla", "silla": "chair"}},
            {"en": "They (m) have lunch here", "es": "Ellos almuerzan aquí", "noun_id": None, "type": "auditory", "glosses": {}},
    ...
    "grammar_present_o_ue_2": {
        ...
        "drill_sentences": [
            ...
            {"en": "We (m) return early", "es": "Nosotros volvemos temprano", "noun_id": None, "type": "auditory", "glosses": {}},
            {"en": "We (f) move the car", "es": "Nosotras movemos el carro", "noun_id": "carro", "type": "written", "glosses": {"car": "carro", "carro": "car"}},
            {"en": "They (m) have lunch early", "es": "Ellos almuerzan temprano", "noun_id": None, "type": "auditory", "glosses": {"early": "temprano", "temprano": "early"}},
    ...
    "grammar_present_o_ue_3": {
        ...
        "drill_sentences": [
            ...
            {"en": "We (m) return tomorrow", "es": "Nosotros volvemos mañana", "noun_id": None, "type": "auditory", "glosses": {}},
            {"en": "We (f) move the boxes", "es": "Nosotras movemos las cajas", "noun_id": None, "type": "written", "glosses": {"boxes": "cajas", "cajas": "boxes"}},
            {"en": "They (m) have lunch fast", "es": "Ellos almuerzan rápido", "noun_id": None, "type": "auditory", "glosses": {"fast": "rápido", "rápido": "fast"}},
    ...
    "grammar_present_e_ie_1": {
        ...
        "drill_sentences": [
            ...
            {"en": "We (m) start early", "es": "Nosotros empezamos temprano", "noun_id": None, "type": "auditory", "glosses": {"early": "temprano", "temprano": "early"}},
            ...
            {"en": "They (m) understand the question", "es": "Ellos entienden la pregunta", "noun_id": None, "type": "auditory", "glosses": {"question": "pregunta", "pregunta": "question"}},
    ...
    "grammar_present_e_ie_2": {
        ...
        "drill_sentences": [
            ...
            {"en": "We (m) start now", "es": "Nosotros empezamos ahora", "noun_id": None, "type": "auditory", "glosses": {}},
            {"en": "We (f) close the store", "es": "Nosotras cerramos la tienda", "noun_id": "tienda", "type": "written", "glosses": {"store": "tienda", "tienda": "store"}},
            {"en": "They (m) understand the plan", "es": "Ellos entienden el plan", "noun_id": "plan", "type": "auditory", "glosses": {}},
    ...
    "grammar_present_e_ie_3": {
        ...
        "drill_sentences": [
            ...
            {"en": "We (m) start work", "es": "Nosotros empezamos el trabajo", "noun_id": "trabajo", "type": "auditory", "glosses": {"work": "trabajo", "trabajo": "work"}},
            {"en": "We (f) close the book", "es": "Nosotras cerramos el libro", "noun_id": "libro", "type": "written", "glosses": {"book": "libro", "libro": "book"}},
            {"en": "They (m) understand well", "es": "Ellos entienden bien", "noun_id": None, "type": "auditory", "glosses": {"well": "bien", "bien": "well"}},
    ...
    "grammar_present_e_i_1": {
        ...
        "drill_sentences": [
            ...
            {"en": "We (m) choose the book", "es": "Nosotros elegimos el libro", "noun_id": "libro", "type": "auditory", "glosses": {"book": "libro", "libro": "book"}},
            {"en": "We (f) ask for water", "es": "Nosotras pedimos agua", "noun_id": None, "type": "written", "glosses": {"water": "agua", "agua": "water"}},
            {"en": "They (m) repeat the sentence", "es": "Ellos repiten la frase", "noun_id": None, "type": "auditory", "glosses": {"sentence": "frase", "frase": "sentence"}},
    ...
    "grammar_present_e_i_2": {
        ...
        "drill_sentences": [
            ...
            {"en": "We (m) choose the city", "es": "Nosotros elegimos la ciudad", "noun_id": "ciudad", "type": "auditory", "glosses": {}},
            {"en": "We (f) ask for help", "es": "Nosotras pedimos ayuda", "noun_id": None, "type": "written", "glosses": {"help": "ayuda", "ayuda": "help"}},
            {"en": "They (m) repeat a song", "es": "Ellos repiten una canción", "noun_id": None, "type": "auditory", "glosses": {"song": "canción", "canción": "song"}},
    ...
    "grammar_present_e_i_3": {
        ...
        "drill_sentences": [
            ...
            {"en": "We (m) choose the restaurant", "es": "Nosotros elegimos el restaurante", "noun_id": None, "type": "auditory", "glosses": {"restaurant": "restaurante", "restaurante": "restaurant"}},
            {"en": "We (f) ask for the bill", "es": "Nosotras pedimos la cuenta", "noun_id": None, "type": "written", "glosses": {}},
            {"en": "They (m) repeat well", "es": "Ellos repiten bien", "noun_id": None, "type": "auditory", "glosses": {"well": "bien", "bien": "well"}},
    ...
    "grammar_ir_a_inf_1": {
        ...
        "drill_sentences": [
            ...
            {"en": "We (m) study Spanish", "es": "Nosotros vamos a estudiar español", "noun_id": None, "type": "auditory", "glosses": {}},
            {"en": "We (f) speak English", "es": "Nosotras vamos a hablar inglés", "noun_id": None, "type": "written", "glosses": {}},
            {"en": "They (m) eat food", "es": "Ellos van a comer comida", "noun_id": None, "type": "auditory", "glosses": {"food": "comida", "comida": "food"}},
    ...
    "grammar_ir_a_inf_2": {
        ...
        "drill_sentences": [
            ...
            {"en": "We (m) study a lot", "es": "Nosotros vamos a estudiar mucho", "noun_id": None, "type": "auditory", "glosses": {"a lot": "mucho", "mucho": "a lot"}},
            {"en": "We (f) speak well", "es": "Nosotras vamos a hablar bien", "noun_id": None, "type": "written", "glosses": {"well": "bien", "bien": "well"}},
            {"en": "They (m) eat fruit", "es": "Ellos van a comer fruta", "noun_id": None, "type": "auditory", "glosses": {}},
    ...
    "grammar_ir_a_inf_3": {
        ...
        "drill_sentences": [
            ...
            {"en": "We (m) study at home", "es": "Nosotros vamos a estudiar en casa", "noun_id": "casa", "type": "auditory", "glosses": {}},
            {"en": "We (f) speak fast", "es": "Nosotras vamos a hablar rápido", "noun_id": None, "type": "written", "glosses": {"fast": "rápido", "rápido": "fast"}},
            {"en": "They (m) eat meat", "es": "Ellos van a comer carne", "noun_id": None, "type": "auditory", "glosses": {"meat": "carne", "carne": "meat"}},
    ...
    "grammar_preterite_regular_1": {
        ...
        "drill_sentences": [
            ...
            {"en": "We (m) left early", "es": "Nosotros salimos temprano", "noun_id": None, "type": "auditory", "glosses": {"early": "temprano", "temprano": "early"}},
            {"en": "We (f) spoke English", "es": "Nosotras hablamos inglés", "noun_id": None, "type": "written", "glosses": {}},
            {"en": "They (m) found work", "es": "Ellos encontraron trabajo", "noun_id": "trabajo", "type": "auditory", "glosses": {}},
    ...
    "grammar_preterite_regular_2": {
        ...
        "drill_sentences": [
            ...
            {"en": "We (m) left from home", "es": "Nosotros salimos de casa", "noun_id": "casa", "type": "auditory", "glosses": {"at home": "en casa", "en casa": "at home"}},
            {"en": "We (f) spoke well", "es": "Nosotras hablamos bien", "noun_id": None, "type": "written", "glosses": {"well": "bien", "bien": "well"}},
            {"en": "They (m) found Maria", "es": "Ellos encontraron a María", "noun_id": None, "type": "auditory", "glosses": {}},
    ...
    "grammar_preterite_regular_3": {
        ...
        "drill_sentences": [
            ...
            {"en": "We (m) left from work", "es": "Nosotros salimos del trabajo", "noun_id": "trabajo", "type": "auditory", "glosses": {"work": "trabajo", "trabajo": "work"}},
            {"en": "We (f) spoke fast", "es": "Nosotras hablamos rápido", "noun_id": None, "type": "written", "glosses": {"fast": "rápido", "rápido": "fast"}},
            {"en": "They (m) found the answer", "es": "Ellos encontraron la respuesta", "noun_id": None, "type": "auditory", "glosses": {"answer": "respuesta", "respuesta": "answer"}},
    ...
    "grammar_preterite_irregular_1": {
        ...
        "drill_sentences": [
            ...
            {"en": "We (m) said the truth", "es": "Nosotros dijimos la verdad", "noun_id": None, "type": "auditory", "glosses": {"truth": "verdad", "verdad": "truth"}},
            ...
            {"en": "They (m) went home", "es": "Ellos fueron a casa", "noun_id": "casa", "type": "auditory", "glosses": {}},
    ...
    "grammar_preterite_irregular_2": {
        ...
        "drill_sentences": [
            ...
            {"en": "We (m) brought the book", "es": "Nosotros trajimos el libro", "noun_id": "libro", "type": "auditory", "glosses": {"book": "libro", "libro": "book"}},
            {"en": "We (f) slept a lot", "es": "Nosotras dormimos mucho", "noun_id": None, "type": "written", "glosses": {"a lot": "mucho", "mucho": "a lot"}},
            {"en": "They (m) died young", "es": "Ellos murieron joven", "noun_id": None, "type": "auditory", "glosses": {"young": "joven", "joven": "young"}},
    ...
    "grammar_preterite_irregular_3": {
        ...
        "drill_sentences": [
            ...
            {"en": "We (m) said thanks", "es": "Nosotros dijimos gracias", "noun_id": None, "type": "auditory", "glosses": {"thanks": "gracias", "gracias": "thanks"}},
            {"en": "We (f) were likeable", "es": "Nosotras fuimos simpático", "noun_id": None, "type": "written", "glosses": {}},
            {"en": "They (m) went to the store", "es": "Ellos fueron a la tienda", "noun_id": "tienda", "type": "auditory", "glosses": {}},
    ...
    "grammar_preterite_irregular_4": {
        ...
        "drill_sentences": [
            ...
            {"en": "We (m) brought coffee", "es": "Nosotros trajimos café", "noun_id": "café", "type": "auditory", "glosses": {"coffee": "café", "café": "coffee"}},
            {"en": "We (f) slept early", "es": "Nosotras dormimos temprano", "noun_id": None, "type": "written", "glosses": {}},
            {"en": "They (m) died of exhaustion", "es": "Ellos murieron de cansancio", "noun_id": None, "type": "auditory", "glosses": {"exhaustion": "cansancio", "cansancio": "exhaustion"}},
    ...
    "grammar_gerund_1": {
        ...
        "drill_sentences": [
            ...
            {"en": "We (m) walk through the park", "es": "Nosotros estamos caminando por el parque", "noun_id": "parque", "type": "auditory", "glosses": {"park": "parque", "parque": "park"}},
            {"en": "We (f) chat here", "es": "Nosotras estamos charlando aquí", "noun_id": None, "type": "written", "glosses": {}},
            {"en": "They (m) eat food", "es": "Ellos están comiendo comida", "noun_id": None, "type": "auditory", "glosses": {"food": "comida", "comida": "food"}},
    ...
    "grammar_gerund_2": {
        ...
        "drill_sentences": [
            ...
            {"en": "We (m) inhibit the idea", "es": "Nosotros estamos inhibiendo la idea", "noun_id": None, "type": "auditory", "glosses": {"idea": "idea"}},
            ...
            {"en": "They (m) leave from work", "es": "Ellos están saliendo del trabajo", "noun_id": "trabajo", "type": "auditory", "glosses": {"work": "trabajo", "trabajo": "work"}},
    ...
    "grammar_gerund_3": {
        ...
        "drill_sentences": [
            ...
            {"en": "We (m) walk home", "es": "Nosotros estamos caminando a casa", "noun_id": "casa", "type": "auditory", "glosses": {}},
            {"en": "We (f) chat well", "es": "Nosotras estamos charlando bien", "noun_id": None, "type": "written", "glosses": {"well": "bien", "bien": "well"}},
            {"en": "They (m) eat meat", "es": "Ellos están comiendo carne", "noun_id": None, "type": "auditory", "glosses": {"meat": "carne", "carne": "meat"}},
    ...
    "grammar_gerund_4": {
        ...
        "drill_sentences": [
            ...
            {"en": "We (m) inhibit the action", "es": "Nosotros estamos inhibiendo la acción", "noun_id": None, "type": "auditory", "glosses": {"action": "acción", "acción": "action"}},
            {"en": "We (f) prohibit that", "es": "Nosotras estamos prohibiendo eso", "noun_id": None, "type": "written", "glosses": {}},
            {"en": "They (m) leave now", "es": "Ellos están saliendo ahora", "noun_id": None, "type": "auditory", "glosses": {}},
    ...
    "grammar_perfect_tenses_drill_1": {
        ...
        "drill_sentences": [
            ...
            {"en": "They (m) have eaten already", "es": "Ellos han comido ya", "noun_id": None, "type": "written", "glosses": {}},
    ...
    "grammar_perfect_tenses_drill_2": {
        ...
        "drill_sentences": [
            ...
            {"en": "They (m) had eaten everything", "es": "Ellos habían comido todo", "noun_id": None, "type": "written", "glosses": {}},
