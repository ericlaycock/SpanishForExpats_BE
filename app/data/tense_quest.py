...
_TENSE_GROUP_DEFS: list[dict[str, Any]] = [
    ...
    {"gl": 17.1, "id": "preterite_irregular", "family": "past",
     "title": "Preterite — Wild Cards", "blurb": "ser/ir · dar/ver · hacer/decir · traer/dormir — the must-know irregular preterites."},
    ...
    {"gl": 17.3, "id": "preterite_stem", "family": "past",
     "title": "Preterite — Strong Stems", "blurb": "estuve · tuve · pude · puse · vine — irregular stems, no accents."},
